...
class F_Test extends StatefulWidget {
  const F_Test({Key? key}) : super(key: key);
  _F_TestState createState() => _F_TestState();
}

class _F_TestState extends State<F_Test> {
  @override
            ...
            children: [
              ...
              Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                Row(
                  ...
                  children: [
                    Image.asset('assets/fKey.png', scale: 4),
                  ],
                )
              ]),
              const Spacer(flex: 4),
                  ...
                  ElevatedButton(
                      ...
                      onPressed: () {
                        Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => const Correct(G_Test())));
                      }),
                  const Spacer(
                    flex: 2,
                  ),
